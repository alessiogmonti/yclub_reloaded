import { Modal, ModalOverlay, 
    ...
    ModalFooter, Heading, UnorderedList, 
    ListItem, Button, useDisclosure, Flex , Box} from "@chakra-ui/react"

export const WebFooter = () => (
    <Box position={'absolute'} ml={2} pl={2} mr={1} pr={1} bottom={-50} right={5}> 
